...
public class Add_Flight_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Add_Flight.setBackground(new java.awt.Color(51, 255, 204));
        ...
        Update.setBackground(new java.awt.Color(0, 255, 153));
        ...
        home.setBackground(new java.awt.Color(0, 255, 153));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/airplane-take-off.png"))); // NOI18N
    ...
    private void Add_FlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add_FlightActionPerformed
       ...
       // String date=da.format(Date.getDate());
        {
        try{
            String sql="insert into flight(Flight_Id,Flight_Name,Source,Destination,Arrival_Time,Departure_Time,Flight_Price)values(?,?,?,?,?,?,?)";
            pst=conn.prepareStatement(sql);
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
       ...
       // String date=da.format(Date.getDate());
        try{
            String sql="update flight set Flight_Name=?, Source=?, Destination=?, Arrival_Time=?, Departure_Time=?, Flight_Price=? where Flight_Id=?";
            pst=conn.prepareStatement(sql);
            pst.setString(7, fid.getText());
            pst.setString(1, fname.getText());
            pst.setString(2, source.getText());
            pst.setString(3, dest.getText());
          //  pst.setString(4,date);
            pst.setString(4, atime.getText());
