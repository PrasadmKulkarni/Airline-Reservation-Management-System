...
public class Cancel_Flight_Ticket extends javax.swing.JFrame {
    ...
    public void Cancel_Ticket(){
      ...
      //  String date1=daa.format(cdate1.getDate());
        String sql="insert into cancel_ticket(Ticket_No,Flight_Id,Flight_Name,Source,Destination,Arrival_Time,Departure_Time,Price,Seats,C_Name)values(?,?,?,?,?,?,?,?,?,?)";
        try{
            pst=conn.prepareStatement(sql);
            pst.setString(1, tno.getText());
         ...
         //   pst.setString(6,date);
            pst.setString(6, arrival.getText());
            pst.setString(7, dept.getText());
            pst.setString(8, price.getText());
            pst.setString(9, seat.getText());
            pst.setString(10, cname.getText());
    ...
    private void initComponents() {
        ...
        cancel.setBackground(new java.awt.Color(102, 255, 51));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/flight-seat.png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cname, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(48, 48, 48))
        );
