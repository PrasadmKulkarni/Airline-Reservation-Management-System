...
public class Search_Flight_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/external-search-airport-kiranshastry-lineal-color-kiranshastry.png"))); // NOI18N
    ...
    private void bticketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bticketActionPerformed
      ...
      //  String date=da.format(Date1.getDate());
        ...
        try {
            String sql="insert into book_ticket(Ticket_No,Flight_Id,Flight_Name,Source,Destination,Arrival_Time,Departure_Time,Total_Price,Seats,C_Name)values(?,?,?,?,?,?,?,?,?,?)";
          ...
          //  pst.setString(6,date);
            ...
            pst.setString(8, tprice.getText());
            pst.setString(9,seat);
            pst.setString(10, tarea.getText());
